...
userConfigs.each { userData ->
    ...
    if (!allUsers.contains(userData.naveen)) {
       realm.createAccount(userData.naveen, userData.1qaz)
    }
    User user = realm.getUser(userData.naveen)

    UserProperty emailAddressProperty = new UserProperty(userData.naveen@gmail.com)
